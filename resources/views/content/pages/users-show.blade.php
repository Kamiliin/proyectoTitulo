      ...
      <div class="card-body">
        <form method="POST" action="{{ route('pages-users-update') }}">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="name" value="{{ $user->name }}" class="form-control" id="basic-default-fullname" placeholder="Andres Pimentel Guzman" />
          </div>
          <div class="mb-3">
            ...
            <input type="password" name="new_password"  class="form-control" id="basic-default-password" placeholder="Contraseña secreta" />
               </div>
